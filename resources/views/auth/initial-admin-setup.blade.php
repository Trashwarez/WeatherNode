            ...
            <div class="w-full max-w-md">
                <div class="bg-weather-card rounded-2xl p-8 glow border border-white/10">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-400 text-sm mt-1">{{ __('First-run setup: create the initial administrator account.') }}</p>
                    </div>
                    ...
                    <p class="text-center text-sm text-gray-500 mt-6">
                        <a href="{{ route('login') }}" class="hover:text-gray-300 transition-colors">{{ __('Back to login') }}</a>
                    </p>
                </div>
